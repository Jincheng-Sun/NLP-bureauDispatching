...
from keras_cnn.createDataset import loadBowDs
import numpy as np
import pickle
import pandas as pd
...
model=Sequential()
model.add(Conv2D(input_shape=[141,141,1],
                 name='conv1',
                 filters=16,
                 kernel_size=(3,3),
                 padding='Same',
...
# feature=
#
model.fit(x=dataX,y=dataY,batch_size=10,epochs=10)
